  ...
  return (
    <section className="contact">
      ...
      <ul className="contact__list">
        ...
        <li className="contact__list__item">
          <a className="contact__list__item__link" href="https://www.linkedin.com/in/william-iehl" target="_blank" rel="noopener noreferrer">
        ...
        <li className="contact__list__item">
          <a className="contact__list__item__link" href="https://github.com/fANZYo" target="_blank" rel="noopener noreferrer">
        ...
        <li className="contact__list__item">
          <a className="contact__list__item__link" href="https://twitter.com/www_iehl" target="_blank" rel="noopener noreferrer">
        ...
        <li className="contact__list__item">
          <a className="contact__list__item__link" href="https://www.facebook.com/www.iehl" target="_blank" rel="noopener noreferrer">
